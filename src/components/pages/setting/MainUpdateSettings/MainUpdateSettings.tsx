...
import {PropsUpdateSettings} from './interfaces';
import styles from './MainUpdateSettings.module.scss';
...
function MainUpdateSettings({}: PropsUpdateSettings) {
...
export default MainUpdateSettings;
