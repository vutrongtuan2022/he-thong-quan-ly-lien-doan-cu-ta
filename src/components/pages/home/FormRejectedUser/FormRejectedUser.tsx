...
import {PropsFormRejectedUser} from './interfaces';
import styles from './FormRejectedUser.module.scss';
...
function FormRejectedUser({uuidRejected, queryKeys, onClose}: PropsFormRejectedUser) {
	...
	const funcRejectedUser = useMutation({
		mutationFn: () =>
			httpRequest({
				...
				http: userServices.rejectedUser({
					uuid: uuidRejected,
...
export default FormRejectedUser;
